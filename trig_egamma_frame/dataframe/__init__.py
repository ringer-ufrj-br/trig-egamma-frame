...
from . import TrackParticle_v2
__all__.extend(TrackParticle_v2.__all__)
from .TrackParticle_v2 import *

from . import Electron_v1
__all__.extend(Electron_v1.__all__)
from .Electron_v1 import *

from . import Electron_v2
__all__.extend(Electron_v2.__all__)
from .Electron_v2 import *

from . import TrigElectron_v1
__all__.extend(TrigElectron_v1.__all__)
from .TrigElectron_v1 import *

from . import TrigElectron_v2
__all__.extend(TrigElectron_v2.__all__)
from .TrigElectron_v2 import *
...
__all__.extend(EmTauRoI_v2.__all__)
from .EmTauRoI_v2 import *

from . import CaloCluster_v1
__all__.extend(CaloCluster_v1.__all__)
from .CaloCluster_v1 import *

from . import CaloCluster_v2
__all__.extend(CaloCluster_v2.__all__)
from .CaloCluster_v2 import *

from . import MonteCarlo_v1
__all__.extend(MonteCarlo_v1.__all__)
from .MonteCarlo_v1 import *

from . import MonteCarlo_v2
__all__.extend(MonteCarlo_v2.__all__)
...
from . import EventInfo_v2
__all__.extend(EventInfo_v2.__all__)
from .EventInfo_v2 import *
