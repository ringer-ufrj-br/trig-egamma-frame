...
class Efficiency(Algorithm):
  ...
  def __init__(self, name,  **kw):
    ...
    declareProperty(self, kw, "basepath"      , "Trigger"   )
  ...
  def fillEfficiency( self, dirname, el, etthr, pidword, isPassed ):
    ...
    if pid: 
      ...
      sg.histogram( dirname+'/highet' ).Fill(et, pw)
      ...
      if isPassed:
        ...
        sg.histogram( dirname+'/match_highet' ).Fill(et, pw)

        sg.histogram( dirname+'/eff_et' ).Fill(et,1, pw)
        sg.histogram( dirname+'/eff_highet' ).Fill(et,1, pw)
        ...
        sg.histogram( dirname+'/eff_highet' ).Fill(et,0)
