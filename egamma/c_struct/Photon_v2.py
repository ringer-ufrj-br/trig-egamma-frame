...
def Photon_v2():
  ...
  code = """
	...
	struct Photon_v2{
		...
		float               ph_ptcone30;
		float               ph_ptcone40;
		float               ph_ptvarcone20;
	    float               ph_ptvarcone30;
		float               ph_ptvarcone40;
        ...
        float               trig_L1_ph_eta{};
		float               trig_L1_ph_phi{};
		float               trig_L1_ph_emClus{};
		float               trig_L1_ph_roi_et{};
		float               trig_L1_ph_emIso{};
		float               trig_L1_ph_hadCore{};
		float               trig_L1_ph_tauClus{};
		float               trig_L1eFex_ph_eta{};
		float               trig_L1eFex_ph_phi{};
		float               trig_L1eFex_ph_roi_et{};
		float               trig_L1eFex_ph_wstot{};
		float               trig_L1eFex_ph_reta{};
		float               trig_L1eFex_ph_rhad{};
	    ...
	    int                 mc_type{};
	    int                 mc_origin{};
	    bool                mc_isTruthPhotonFromZ{};
	    bool                mc_isTruthPhotonFromW{};
	    bool                mc_isTruthPhotonFromJpsi{};
	    bool                mc_isTruthPhotonAny{};
