...
cv.from_csv('output/crossval/table_run3_v0.csv')
...
best_sorts_refit.to_csv('output/fitting/v0/best_sorts_run3_v0.csv')
#best_sorts_refit = pd.read_csv('output/fitting/v0/best_sorts_run3_v0.csv')


for op in op_names:
    fit.dump_beamer_table( best_sorts_refit.loc[best_sorts_refit.op_name == op] ,                  
                              op+' Fitting (Run3 v0)', 'fitting_run3_v0_'+op)
...
model_name_format = 'mc21_13p6TeV.801272_Jpsie.601189_Zee.801278_perf_JF17.40bins.Electron{op}.Run3_v0.et%d_eta%d'
...
os.system('mv models output/fitting/v0')
os.system('mv *.conf output/fitting/v0')
os.system('mv *.pdf output/fitting/v0')
os.system('mv *.tex output/fitting/v0')