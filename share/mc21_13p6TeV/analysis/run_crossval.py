...
cv_run2.fill('/home/joao.pinto/public/cern_data/tunings/Run2/v8/r1/user.jodafons.mc21_13p6TeV*/*/*.pic','Run2-v8')
...
cv_run2.to_csv(output_path+'/table_run2_v8.csv')
cv_v0.to_csv(output_path+'/table_run3_v0.csv')
cv_v1.to_csv(output_path+'/table_run3_v1.csv')



cv_run2.from_csv(output_path+'/table_run2_v8.csv')
