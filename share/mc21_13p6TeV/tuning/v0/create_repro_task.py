...
for et in range(8):
    ...
    for eta in range(5):
        ...
        inputs = home+f'/tunings/Run3/v0/r0/mc21_13p6TeV.801272.P8B_A14_CTEQ6L1_Jpsie.601189.PhPy8EG_AZNLO_Zee.801278.Py8EG_A14NNPDF23LO_perf_JF17.40bins.et{et}_eta{eta}.v0'
